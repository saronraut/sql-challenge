-- After using https://app.quickdatabasediagrams.com/#/d/9KnVjV to create a diagram. when exporting it created the create table format. 
...
-- verify that all emp count are same as csv
